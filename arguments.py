...
parser.add_argument(
    "--colearnability_weight",
    type=float,
    default=1.0,
    help="Weight for co-learnability score.",
)
parser.add_argument(
    "--transition_prob_weight",
    type=float,
    default=1.0,
    help="Weight for transition probability score.",
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=int,
    default=0,
    help="CUDA device number to use. Defaults to 0.",
)
...
parser.add_argument(
    ...
    type=str,
    default="v1.0.0",
    help="Version of the config. Used for logging and tracking.",
)
parser.add_argument(
    "--use_traced",
    type=str2bool,
    ...
    const=True,
    default=False,
    help="Use traced models for faster inference.",
)
